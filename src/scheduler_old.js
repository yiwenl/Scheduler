...
// expected frame rate, for defer tasks
let frameRate = 60;
...
/**
 * Set the (expected) frame rate for defer tasks
 *
...
function process() {
  ...
  // Delta time calculation based on the desired frame rate
  deltaTime = (currentTime - prevTime) * (frameRate / 60); // Scale to the target frame rate
